...
<div className={styles.mainDiv}>
  <div style={{ margin: `0 auto`, maxWidth: 900, padding: `1.25rem 1rem` }}>
    <header className={styles.header} style={{ marginBottom: `1rem`, width: `100%` }}>
      <ListLink to="/" style={{ textShadow: `none`, backgroundImage: `none` }}>
        <h2 className={styles.logo} style={{ display: `inline`, }}>DANIELLE BENNETT</h2>
      </ListLink>
  ...
  <footer className={styles.footer} style={{ width: `100%`, position: `fixed`, bottom: `0`, opacity: `0.95`, textAlign: `center`, fontFamily: `Open Sans`, padding: `0.5rem`, margin: `0`, fontSize: `.9rem`, fontStyle: `italic`, fontWeight: `bold` }}>
